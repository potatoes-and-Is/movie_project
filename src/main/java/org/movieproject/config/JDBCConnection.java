...
public class JDBCConnection {
    ...
    static {
        try {
             ...
             * Hashtable의 서브 클래스이며 키와 값이 모두 문자열(String) 으로 제한된다.
             * Ex) => db.url=jdbc:mysql://localhost:3306/mydb
             */
            ...
            config.setMaxLifetime(1800000); // 커넥션이 풀에서 유지될 수 있는 최대 수명(밀리초)를 지정한다.
    ...
    public static Connection getConnection() throws SQLException {
         ...
         * 여기서 지금 우리가 사용하는 hikari의 경우 DB의 커넥션 객체를 몇 개 생성하고
